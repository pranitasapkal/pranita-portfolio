  ...
  chapters: [
    ...
    // ── STEP 05 ───────────────────────────────────────────────────────────
    {
      ...
      blocks: [
        ...
        {
          type: 'text',
          body: "**Dispute** is reachable only from Active rows without an open dispute; with one open, the CTA disables with a plain-language tooltip. The success state is a neutral document icon and \"We've received your dispute. Expect an update within 24 hours\" — the confetti treatment from an earlier screen was removed because a grievance acknowledged is not a celebration.\n\n**Session entry** passes through a passcode gate on the contract area only: transporters share their logged-in laptop with staff, and contract rates are confidential. First-time flow is OTP-to-registered-mobile → create password, fronted by an intro screen in three 2–4-word bullets (\"Private page / Your contracts and money / Only you can open it\") and an amber callout: \"Do not tell anyone — not even your staff.\"",
        },
        {
          type: 'statRow',
          stats: [
    ...
    // ── STEP 06 ───────────────────────────────────────────────────────────
    {
      ...
      blocks: [
        ...
        {
          type: 'text',
          body: 'The wireframes were validated against a 34-row state matrix — every tag, chip, and banner rule had to render correctly against every row before hi-fi started. The matrix is also the prototype\'s test data, so the spec and the demo can\'t drift.',
        },
        {
          type: 'matrix',
