 ...
 *   - assignment-module, linehaul-nexus → pick an existing frame from public/work/
 ...
 * own relative assets. Chrome path matches gen-assignment-diagrams.mjs.
 *
 * Run: npm run covers
 */
...
const FROM_FILE = [
  ...
  // strikethrough. Verified against the rest of the assignment set, which is clean, so it
  ...
  ['assignment-module', 'public/work/assignment/upcoming-list.png'],
]
